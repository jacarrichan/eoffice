Ext.ns("ArchivesIssueProof");
ArchivesIssueProof = Ext
		.extend(
				Ext.Panel,
				{
					searchPanel : null,
					...
					constructor : function(a) {
						...
						ArchivesIssueProof.superclass.constructor.call(this, {
							id : "ArchivesIssueProof",
							iconCls : "menu-archive-proof",
							title : "发文校对",
							region : "center",
							layout : "border",
									...
									columns : [
											...
											},
											{
												...
												renderer : function(c) {
													if (c == 5) {
														...
														return '<font color="green">已校对</font>';
													}
												}
											},
											{
											...
											},
											{
												...
												renderer : function(g, f, d, j,
													...
													var c = d.data.status;
													var h = "";
													h += '<button title="查阅详情" value=" " class="btn-archives-detail" onclick="ArchivesIssueProof.detail(' + i + ')">&nbsp;&nbsp;</button>';
													if (c == "5"
															&& isGranted("_ArchivesIssueProofEdit")) {
														h += '<button title="管理附件" value=" " class="btn-archive-attachment" onclick="ArchivesIssueProof.attach(' + i + ')">&nbsp;&nbsp;</button>';
													}
													return h;
												}
											} ],
...
ArchivesIssueProof.detail = function(a) {
	new ArchivesDetailWin( {
		archivesId : a
	}).show();
};
ArchivesIssueProof.attach = function(a) {
	new ArchivesDocWin( {
		archivesId : a
	}).show();
};