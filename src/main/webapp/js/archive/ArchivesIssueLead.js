Ext.ns("ArchivesIssueLead");
ArchivesIssueLead = Ext
		.extend(
				Ext.Panel,
				{
					searchPanel : null,
					...
					constructor : function(a) {
						...
						ArchivesIssueLead.superclass.constructor.call(this, {
							id : "ArchivesIssueLead",
							iconCls : "menu-archive-lead",
							title : "主管领导审核",
							region : "center",
							layout : "border",
									...
									columns : [
											...
											},
											{
												...
												renderer : function(g, f, d, j,
													...
													var c = d.data.status;
													var h = "";
													if (isGranted("_ArchivesIssueLeadEdit")) {
														h += '<button title="编辑" value=" " class="btn-edit" onclick="ArchivesIssueLead.edit(' + i + ')">&nbsp;&nbsp;</button>';
													}
													h += '<button title="查阅详情" value=" " class="btn-archives-detail" onclick="ArchivesIssueLead.detail(' + i + ')">&nbsp;&nbsp;</button>';
													return h;
												}
											} ],
									defaults : {
...
ArchivesIssueLead.edit = function(a) {
	new ArchivesDraftWin( {
		archivesId : a
	}).show();
};
ArchivesIssueLead.detail = function(a) {
